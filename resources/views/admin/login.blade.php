...
<head>
    ...
    <title>Login Administrador - NeuroIsbe</title>
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl font-black text-slate-800 tracking-tight">
                <span class="bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent">Neuro</span>Isbe
            </h1>
            <p class="text-sm text-slate-400 font-medium mt-1">Painel de Administração</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8">
            ...
            <div class="text-center mb-7">
                <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-purple-700 shadow-lg shadow-purple-500/20 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="white" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M6.429 9.75 2.25 12l4.179 2.25m11.142 0L21.75 12l-4.179-2.25M12 5.25 15.75 7.5 12 9.75 8.25 7.5 12 5.25Zm0 11.25L15.75 14.25 12 16.5l-3.75-2.25L12 16.5Z"/></svg>
                </div>
                <h2 class="text-xl font-bold text-slate-800">Administrador</h2>
                <p class="text-sm text-slate-400 mt-1">Acesso restrito ao painel de controle</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.login') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="username" required autocomplete="username" autofocus
                        class="block w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 rounded-xl text-sm font-medium text-slate-800 placeholder-slate-400 transition-all outline-none"
                ...
                <button type="submit"
                    class="w-full py-3 px-4 bg-gradient-to-r from-purple-500 to-purple-700 hover:from-purple-600 hover:to-purple-800 text-white rounded-xl text-sm font-bold shadow-lg shadow-purple-500/20 hover:shadow-xl hover:shadow-purple-500/30 transition-all transform active:scale-[0.98] outline-none">
            ...
            <div class="mt-7 pt-5 border-t border-slate-100">
                ...
                <div class="flex items-center justify-center gap-3">
                    <a href="{{ route('login') }}"
                        class="flex items-center gap-2 px-4 py-2.5 border border-cyan-200 hover:border-cyan-400 hover:bg-cyan-50 text-cyan-600 rounded-xl text-xs font-semibold transition-all">
        ...
        <p class="text-center text-xs text-slate-400 mt-6">
            &copy; {{ date('Y') }} NeuroIsbe. Todos os direitos reservados.
        </p>
    </div>
